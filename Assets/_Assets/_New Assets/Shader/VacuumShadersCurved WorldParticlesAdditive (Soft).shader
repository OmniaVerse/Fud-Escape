Shader "VacuumShaders/Curved World/Particles/Additive (Soft)" {
	...
	SubShader {
		Tags { "CurvedWorldAvailableOptions" = " " "CurvedWorldNoneRemoveableKeywords" = "" "CurvedWorldTag" = "Particles/Additive (Soft)" "IGNOREPROJECTOR" = "true" "QUEUE" = "Transparent" "RenderType" = "Transparent" }
		Pass {
			Tags { "CurvedWorldAvailableOptions" = " " "CurvedWorldNoneRemoveableKeywords" = "" "CurvedWorldTag" = "Particles/Additive (Soft)" "IGNOREPROJECTOR" = "true" "QUEUE" = "Transparent" "RenderType" = "Transparent" }
