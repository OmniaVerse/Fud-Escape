Shader "VacuumShaders/Curved World/Particles/Alpha Blended" {
	...
	SubShader {
		Tags { "CurvedWorldAvailableOptions" = " " "CurvedWorldNoneRemoveableKeywords" = "" "CurvedWorldTag" = "Particles/Alpha Blended" "IGNOREPROJECTOR" = "true" "QUEUE" = "Transparent" "RenderType" = "Transparent" }
		Pass {
			Tags { "CurvedWorldAvailableOptions" = " " "CurvedWorldNoneRemoveableKeywords" = "" "CurvedWorldTag" = "Particles/Alpha Blended" "IGNOREPROJECTOR" = "true" "QUEUE" = "Transparent" "RenderType" = "Transparent" }
