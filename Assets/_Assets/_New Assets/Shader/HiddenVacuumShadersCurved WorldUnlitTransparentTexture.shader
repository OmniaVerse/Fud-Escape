Shader "Hidden/VacuumShaders/Curved World/Unlit/Transparent/Texture" {
	...
	SubShader {
		LOD 100
		Tags { "CurvedWorldAvailableOptions" = "V_CW_REFLECTIVE;V_CW_VERTEX_COLOR;V_CW_IBL;_EMISSION;V_CW_RIM;V_CW_FOG;_NORMALMAP;" "CurvedWorldNoneRemoveableKeywords" = "" "CurvedWorldTag" = "Unlit/Transparent/Texture" "IGNOREPROJECTOR" = "true" "QUEUE" = "Transparent+1" "RenderType" = "Transparent" }
		Pass {
			Name "BASE"
			LOD 100
			Tags { "CurvedWorldAvailableOptions" = "V_CW_REFLECTIVE;V_CW_VERTEX_COLOR;V_CW_IBL;_EMISSION;V_CW_RIM;V_CW_FOG;_NORMALMAP;" "CurvedWorldNoneRemoveableKeywords" = "" "CurvedWorldTag" = "Unlit/Transparent/Texture" "IGNOREPROJECTOR" = "true" "QUEUE" = "Transparent+1" "RenderType" = "Transparent" }
			...
			Program "vp" {
				...
				SubProgram "gles " {
					...
					void main()
					{
					    ...
					    u_xlat3.xyz = u_xlat10_1.xyz * _Color.xyz + (-unity_FogColor.xyz);
