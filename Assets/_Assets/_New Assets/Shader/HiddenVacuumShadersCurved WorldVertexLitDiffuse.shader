Shader "Hidden/VacuumShaders/Curved World/VertexLit/Diffuse" {
	...
	SubShader {
		...
		Pass {
			...
			Program "vp" {
				SubProgram "gles " {
					Keywords { "V_CW_FOG_OFF" "V_CW_RIM_OFF" "V_CW_VERTEX_COLOR_OFF" }
					"!!GLES
					#ifdef VERTEX
					#version 100
				...
				SubProgram "gles " {
					Keywords { "FOG_LINEAR" "V_CW_FOG_OFF" "V_CW_RIM_OFF" "V_CW_VERTEX_COLOR_OFF" }
					"!!GLES
					#ifdef VERTEX
					#version 100
				...
				SubProgram "gles " {
					Keywords { "FOG_EXP2" "V_CW_FOG_OFF" "V_CW_RIM_OFF" "V_CW_VERTEX_COLOR_OFF" }
					"!!GLES
					#ifdef VERTEX
					#version 100
