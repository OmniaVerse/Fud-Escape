			...
			Program "vp" {
				SubProgram "gles hw_tier00 " {
					...
					void main()
					{
					    ...
					    SV_Target0.xyz = vec3(dot(u_xlat0.xyz, vec3(0.212500006, 0.715399981, 0.0720999986)));
				...
				SubProgram "gles hw_tier00 " {
					...
					void main()
					{
					    ...
					    SV_Target0.xyz = vec3(dot(u_xlat1.xyz, vec3(0.212500006, 0.715399981, 0.0720999986)));
