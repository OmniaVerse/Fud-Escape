Shader "Hidden/VacuumShaders/Curved World/Unlit/Cutout/Texture" {
	...
	SubShader {
		LOD 100
		Tags { "CurvedWorldAvailableOptions" = "V_CW_REFLECTIVE;V_CW_VERTEX_COLOR;V_CW_IBL;_EMISSION;V_CW_RIM;V_CW_FOG;_NORMALMAP;" "CurvedWorldNoneRemoveableKeywords" = "" "CurvedWorldTag" = "Unlit/Cutout/Texture" "IGNOREPROJECTOR" = "true" "QUEUE" = "AlphaTest" "RenderType" = "CurvedWorld_TransparentCutout" }
		Pass {
			LOD 100
			Tags { "CurvedWorldAvailableOptions" = "V_CW_REFLECTIVE;V_CW_VERTEX_COLOR;V_CW_IBL;_EMISSION;V_CW_RIM;V_CW_FOG;_NORMALMAP;" "CurvedWorldNoneRemoveableKeywords" = "" "CurvedWorldTag" = "Unlit/Cutout/Texture" "IGNOREPROJECTOR" = "true" "QUEUE" = "AlphaTest" "RenderType" = "CurvedWorld_TransparentCutout" }
			GpuProgramID 1865
