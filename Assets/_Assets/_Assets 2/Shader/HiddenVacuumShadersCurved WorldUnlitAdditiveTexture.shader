Shader "Hidden/VacuumShaders/Curved World/Unlit/Additive/Texture" {
	...
	SubShader {
		LOD 100
		Tags { "CurvedWorldAvailableOptions" = "V_CW_REFLECTIVE;V_CW_VERTEX_COLOR;V_CW_IBL;_EMISSION;V_CW_RIM;V_CW_FOG;_NORMALMAP;" "CurvedWorldNoneRemoveableKeywords" = "" "CurvedWorldTag" = "Unlit/Additive/Texture" "IGNOREPROJECTOR" = "true" "QUEUE" = "Transparent+1" "RenderType" = "Transparent" }
		Pass {
			Name "BASE"
			LOD 100
			Tags { "CurvedWorldAvailableOptions" = "V_CW_REFLECTIVE;V_CW_VERTEX_COLOR;V_CW_IBL;_EMISSION;V_CW_RIM;V_CW_FOG;_NORMALMAP;" "CurvedWorldNoneRemoveableKeywords" = "" "CurvedWorldTag" = "Unlit/Additive/Texture" "IGNOREPROJECTOR" = "true" "QUEUE" = "Transparent+1" "RenderType" = "Transparent" }
