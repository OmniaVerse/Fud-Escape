...
public class Modules : MonoBehaviour {
    ...
    public static Modules Instance { set; get; }
    ...
    public static void HandleGameOver()
    {
        ...
        if (scorePlayer > 1)
        {
            ...
            SaveScore();
            PlayfabManager.Instance.SendLeaderboard((int)scorePlayer);
...
#else
    public static string linkStoreGame = "";
#endif
    public static string linkIconGame = "http://52.220.93.168/Others/Icons/IconFruntastic.png";
    public static string linkChange = "https://play.google.com/store/apps/details?id=com.block.fudescape";
    ...
    public static void Reward_Board()
    {
    ...
    public static void Reward_Coins()
    {
        totalCoin += 500;
        SaveCoin();
    }

    public static void Reward_Key()
    {
    ...
    {
        Modules.totalHeadStart+=3;
        Modules.SaveHeadStart();
    }

    public static void ChestReward()
    {
